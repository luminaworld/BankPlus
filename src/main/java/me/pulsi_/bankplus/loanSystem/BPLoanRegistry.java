...
public class BPLoanRegistry {
    ...
    public static void registerLoan(BPLoan loan) {
        ...
        loan.setTask(BPScheduler.runTaskLater(() -> advanceReturningTask(loan), delay));
    }
    ...
    public static void queueLoanRequest(Player sender, LoanRequest loanRequest) {
        ...
        BPScheduler.runTaskLater(() -> requests.remove(uuid), ConfigValues.getLoanAcceptTime() * 20L);
    }
    ...
    private static void advanceReturningTask(BPLoan loan) {
        ...
        else loan.setTask(BPScheduler.runTaskLater(() -> advanceReturningTask(loan), ConfigValues.getLoanDelay()));
    }
